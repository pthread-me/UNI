...
\begin{document}
	...
	\textbf{\underline{Steps:}}
	\begin{enumerate}
		\item We only have one non-basic variable with possitive objective 
			function coofficient , so we start by swapping $z'$ and $z''$.
		...
		\item repeat with $z''$ entering the basis and $z'$ leaving
			\begin{enumerate}
				\item (2) * -1
